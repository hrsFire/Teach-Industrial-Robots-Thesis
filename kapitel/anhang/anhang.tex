...
source ~/.bashrc
            ...
            \item Den Source Code der Roboter-Gesten-Anwendung auf dem Beilagemedium aus dem Verzeichnis \quoteMark{Repositories/Teach-Industrial-Robots} klonen, Abhängigkeiten installieren und anschließend die Roboter-Gesten-Anwendung kompilieren:
                \begin{lstlisting}[style=bash]
mkdir -p ~/tir_ws/src
cd ~/tir_ws/
catkin build -DCMAKE_BUILD_TYPE=Release
