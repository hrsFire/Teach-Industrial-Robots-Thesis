...
\hline
-rn="\phantom{}<name>" & \texttt{-{}-}robot-name="\phantom{}<name>" & Name des Roboters (Default: "wx200")\\
\hline
-rm="\phantom{}<name>" & \texttt{-{}-}robot-model="\phantom{}<name>" & Robotermodell (in der Regel derselbe wie der Name des Roboters; Default: "wx200")\\
\hline
