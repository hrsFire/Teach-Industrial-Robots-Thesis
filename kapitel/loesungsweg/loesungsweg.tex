...
Aufgrundlage der ermittelten Limitierungen der Azure Kinect und der untersuchten ethischen Voraussetzungen können nun entsprechende Gesten entwickelt werden, welche die Anforderungen an die sicherheitskritische Steuerung eines Industrieroboters zur Vermeidung von Unfällen erfüllen, aber auch aus ergonomischer Sicht einfach und angenehm auszuführen sind und im besten Fall während des Teachens keine großen Ermüdungserscheinungen aufweisen. Um dies zu erreichen ist es unter anderem notwendig keine komplizierten Gesten zu wählen, da hierdurch die Erlernbarkeit der vorhandenen Gesten vereinfacht wird \cite[97]{schleicher_einfuhrung_2020} und mit ausgestreckten Armen durchgeführte Freihandgesten möglichst zu vermeiden, wenn diese auf Dauer ausgeführt werden müssen \cite[84]{neupert_naturliche_nodate}. Zudem steigert eine direkte und natürliche Interaktion, welche intuitiv und einfach gestaltet ist, die Zufriedenheit der Personen, welche die Geste einsetzen müssen \cite[103]{schleicher_einfuhrung_2020}. Zudem ist eine ausreichende Rückmeldung des Gestensystems praktisch, da hierdurch die Zufriedenheit der bedienenden Person und dessen Vertrauen zum System gesteigert wird \cite[132\psq]{schleicher_einfuhrung_2020}.
