...
Die in dieser Arbeit entwickelte Roboter-Gesten-Anwendung baut auf dem Roboter-Gesten-Framework, welches zusätzlich in dieser Arbeit erstellt wurde, auf. Der Vorteil des Roboter-Gesten-Frameworks besteht darin, dass durch dessen Einsatz die Entwicklung von einer Anwendung zur Gestensteuerung vereinfacht und dadurch auch beschleunigt wird. Das Roboter-Gesten-Framework bietet neben der Möglichkeit vordefinierte Gestenerkennungsalgorithmen zu verwenden, auch die Möglichkeit an um Industrieroboter über eine einheitliche Schnittstelle ansprechen zu können. Die Gestensteuerung kann jedoch unabhängig von einem Roboter und ROS erfolgen, da die Gesten- und Roboterkomponenten lose gekoppelt wurden und so mit verschiedenen Systemkonstellationen zusammenarbeiten können. Die Roboter-Gesten-Anwendung wurde als Demonstrationsanwendung entworfen um eine mögliche Nutzung des Roboter-Gesten-Frameworks vorzuzeigen.\\

\textcolor{red}{Gesten-Subsystem: UML (Ablaufdiagramm?}\\

Das Gesten-Subsystem verwaltet dabei die zugewiesenen Gesten und deren auszuführende Aktionen. Die Gesten können dabei in sogenannte Gesten-Gruppen unterteilt werden um die Gesten einer kategorischen Gliederung zu unterwerden. Zudem bieten diese den Vorteil um ähnliche oder Gesten oder gegensätzliche Aktionen voneinander isolieren zu können. \textcolor{red}{TODO: Abhängigkeiten}

\textcolor{red}{Todo: Roboter-Gesten-Anwendung UML Hierarchie}\\

Die Roboter-Gesten-Anwendung wurde mit dem Roboter-Gesten-Framework erstellt und nutzt dieses daher als Grundlage. In dieser Anwendung wurden zudem die ausgewählten Gesten mithilfe der Gestenerkennungsalgorithmen des Roboter-Gesten-Frameworks umgesetzt. Hierzu verwendet es die vom Roboter-Gesten-Framework angebotenen Programmierschnittstellen um die Azure Kinect und den \quoteMark{WidowX 200}-Lernroboter, welcher über ROS oder eine direkte Kommunikation angesteuert werden kann, miteinander kommunizieren lassen zu können. Für die direkte Kommunikation musste für den \quoteMark{WidowX 200}-Lernroboter das \quoteMark{InterbotiX}-SDK für die direkte Kommunikation erweitert werden um eine vergleichbare Implementierung der ROS und der direkten Kommunikation gewährleisten zu können. Durch Implementierung der entsprechenden Programmierschnittstellen wäre es neben dem \quoteMark{WidowX 200}-Lernroboter daher auch möglich andere Komponenten mithilfe der Roboter-Gesten-Anwendung zu steuern.\\

\textcolor{red}{TODO: UML-Diagramm, Regelkreis, Besprechung}\\

Die Roboter-Gesten-Anwendung kann daher als Steuerungseinheit angesehen werden. Diese regelt wie in Abbildung \ref{} zu sehen ist die Eingaben innerhalb eines Regelkreises und steuert bei einer korrekt erkannten Eingabe die Komponenten auf die entsprechende Art und Weise.\\
...
\textcolor{red}{TODO:\\
Roboter-Gesten-Framework mit UML erklären\\
