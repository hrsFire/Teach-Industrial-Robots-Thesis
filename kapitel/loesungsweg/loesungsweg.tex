...
Aufgrundlage der ermittelten Limitierungen der Azure Kinect und der untersuchten ethischen Voraussetzungen können nun entsprechende Gesten entwickelt werden, welche die Anforderungen an die sicherheitskritische Steuerung eines Industrieroboters aus ergonomischer Sicht, aber auch zur Vermeidung von Unfällen mit Industrierobotern, erfüllen können.
\textcolor{red}{TODO:}
...
% keine komplizierten Kommandos (z.B. Gesten- oder Zeichen-vokabulare: Handzeichen, geometrische Formen und Farben) zur einfachen und schnellen Erlernbarkeit
% S. 97  2020_Book_KollaborierendeRoboterAnweisen.pdf
%
% direkte und natürliche Interaktion intuitive und einfache Gestaltung (Zufriedenstellung) universelle Zugänglichkeit (Effizienz)
% S. 103  2020_Book_KollaborierendeRoboterAnweisen.pdf
%
% Im Falle einer Gestensteuerung (GS) sorgt die Bewegung im Arbeitsraum des Roboters für ein geringes Sicherheitsgefühl bei den Nutzern. Bei der Verwen- dung einer rein gestenbasierten Eingabe ist die mangelnde Rückmeldung ein we- sentlicher Schwachpunkt dieser MRS-Technologie für den Einsatz in einer iMRK. Hinzu kommt die Möglichkeit von unbeabsichtigten Eingaben bei Verwendung ohne zusätzlicher Eingabegeräte.
% S. 132  2020_Book_KollaborierendeRoboterAnweisen.pdf
%
...
Wie in Abbildung \ref{fig:joint_hierarchy} zu sehen ist, können bei der linken und rechten Hand unter anderem die Handspitze, der Daumen, ca. die Mitte der Hand und das Gelenk über das Azure Kinect Body Tracking SDK, welches 32 spezifischen Positionen des menschlichen Körpers identifzieren kann, genutzt werden. Die Bestimmung und Nutzung der einzelnen Finger der linken und rechten Hand ist daher nicht möglich und daher können die einzelnen Finger mit der Azure Kinect nicht zur Gestensteuerung eines Industrieroboters eingesetzt werden. Aus diesem Grund werden zur Gestensteuerung des Industrieroboters auf feinmotorische Gesten mit den einzelnen Fingern, zu denen z.B. das Skalieren mit zwei Fingern zählt, verzichtet \cite{qm13_azure_joints_nodate}.\newline




\textcolor{red}{TODO:}\newline
In der Tabelle \ref{tab:implementierte_gesten} sind die für die Gestensteuerung des Industrieroboters aufgestellten Gesten ersichtlich. Zum besseren Verständnis der Gesten wurden diese zudem mit den in Abbildung \ref{fig:joint_hierarchy} ersichtlichen 32 spezifischen Positionen des menschlichen Körpers, welche durch die Azure Kinect bereitgestellt werden, übersichtlich verknüpft. Bei der Entwicklung der Gesten wurde darauf geachtet, dass die Gesten den Links- und Rechtshändern eine entspannte Möglichkeit bieten den Industrieroboter über die für das Teachen vorgesehene Zeit zu bedienen. Aus diesem Grund war bei der Entwicklung der Gesten sehr wichtig der bedienenden Person bei längeren Bedienungsvorgängen, wie z.B. der Gelenkstellung erhöhen, eine Möglichkeit zum Ablegen der Hände zu bieten um so Ermüdungserscheinungen vorbeugen zu können. Auf der anderen Seite war jedoch aber bei der Entwicklung der Gesten auch wichtig, die Gesten in einer gewissen Distanz voneinander anzuordnen um so unbeabsichtigte Betätigungen mehrerer Gesten während des Bedienungsvorganges zu minimieren. Unbeabsichtigte Gesten können jedoch aber auch durch reflexartige Bewegungen zum Schutz des eigenen Lebens entstehen. Diese reflexartigen und unbeabsichtigten Gesten, wie z.B. das Schützen des Kopfes mit den Händen, wurden bei der Entwicklung der Gesten mitberücksichtigt und werden vom System größtmöglich herausgefiltert.
...
\paragraph*{$^{\ast1}$}\label{ast:gesten_anmerkung_1}\small{Wenn der Präzisionsmodus ausgeschalten (Beschleunigung aktiviert) ist, führt ein längeres verharren in dieser Pose zu einer Beschleunigung der jeweiligen Bewegung.}
...
In der Tabelle \ref{tab:implementierte_gesten} sind die Aktionen, welche mit Gesten verknüft wurden aufgelistet. Zu jeder Geste wird eine genaue Beschreibung angegeben um die Geste ordnungsgemäß ausführen zu können. In manchen Fällen, wie z.B. beim Umschalten des Präzisionsmodus, kann dies je nach Präferenz durch die linke oder rechte Hand erfolgen. Hierdurch steht es der Person frei die Geste seiner Wahl für den jeweiligen Anwendungsfall auszuwählen. Zur Erhöhung der Sicherheit wurde eine Möglichkeit implementiert den Endeffektor zu sperren, damit keine Aktionen mit ihm ausgeführt werden können. Z.B. wenn der Endeffektor eine Last transportiert ist es Wichtig, dass diese nicht plötzlich durch ungewolltes öffnen des Endeffektors fallen gelassen wird und so ungewollt einen Schaden verursachen würde. Standardmäßig ist der Endeffektor nicht gesperrt, da im Normalfall am Anfang noch keine Last transportiert wird. Der Präzisionsmodus ermöglicht das Wechseln zwischen präziser immer gleich bleibender Geschwindigkeit mit einer für den Industrieroboter voreingesellten Minimalgeschwindigkeit und einem unpräzisen aber dafür schnelleren Modus, bei dem die Geschwindigkeit und Beschleunigung bis zu einem für den jeweiligen Industrieroboter zum sicheren Teachen vorgegebenen Schwellwert erreicht wird.
...
controller mit drucksensor
% https://www.amazon.de/gp/product/B077SRP4Q9/ref=ox_sc_act_title_1?smid=ADR4M3MFY6SKF&psc=1
}
