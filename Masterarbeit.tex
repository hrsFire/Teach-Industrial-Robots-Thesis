...
\begin{titlepage}
  ...
  \subsection*{Teachen von Industrierobotern mittels Gestenerkennung}
  \vspace{1cm}
...
\input{kapitel/gender_erklaerung/gender_erklaerung}

% evtl. Widmung:
%\newpage
%\section*{Widmung}   % evtl. ersetzen durch \section*{Widmung}
%
%Nachfolgend möchte ich mich bei allen bedanken, welche mich während der Anfertigung dieser Arbeit unterstützt haben.\\
%
...
\subsection*{Teachen von Industrierobotern mittels Gestenerkennung}
\input{kapitel/kurzreferat/de/kurzreferat}

% Abstract:
\newpage
\section*{Abstract}
\subsection*{Teaching of industrial robots using gesture recognition}
\input{kapitel/kurzreferat/en/abstract}
...
\input{kapitel/abkuerzungsverzeichnis/abkuerzungsverzeichnis}

\chapter{Einleitung}
\input{kapitel/einleitung/einleitung}

\chapter{Stand der Technik} % Ausgangslage, Anforderungsanalyse
\input{kapitel/stand_der_technik/stand_der_technik}

\chapter{Umsetzung} % Vorgehensweise
\input{kapitel/loesungsweg/loesungsweg}

\chapter{Ergebnisse}
\input{kapitel/ergebnisse/ergebnisse}

\chapter{Zusammenfassung \& Ausblick}
\input{kapitel/zusammenfassung_ausblick/zusammenfassung_ausblick}
